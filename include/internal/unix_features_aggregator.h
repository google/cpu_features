...
#define DECLARE_SETTER(FeatureType, FeatureName) \
  static void set_##FeatureName(void* const features, bool value) { ((FeatureType*)features)->FeatureName = value; }

// Use the following macro to declare getter functions to be used in
// CapabilityConfig.
#define DECLARE_GETTER(FeatureType, FeatureName) \
  static int get_##FeatureName(void* const features) { return ((FeatureType*)features)->FeatureName; }
...
void CpuFeatures_SetFromFlags(const size_t configs_size, const CapabilityConfig* configs, const StringView flags_line,
                              void* const features);
...
// Note: features is a pointer to the underlying Feature struct.
void CpuFeatures_OverrideFromHwCaps(const size_t configs_size, const CapabilityConfig* configs,
                                    const HardwareCapabilities hwcaps, void* const features);
