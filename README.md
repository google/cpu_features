...
| :-- | --: | --: | --: | --: |
| amd64 | [![CMake][i1a0]][l1a0]<br/>[![Bazel][i1a1]][l1a1]<br/>[![Zig][i1a2]][l1a2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | [![CMake][i3a0]][l3a0]<br/>[![Bazel][i3a1]][l3a1]<br/>[![Zig][i3a2]][l3a2] | [![CMake][i4a0]][l4a0]<br/>[![Bazel][i4a1]][l4a1]<br/>[![Zig][i4a2]][l4a2] |
| AArch64 | [![CMake][i1b0]][l1b0]<br/>[![Bazel][i1b1]][l1b1]<br/>[![Zig][i1b2]][l1b2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] |
| ARM | [![CMake][i1c0]][l1c0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] |
| MIPS | [![CMake][i1d0]][l1d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] |
| POWER | [![CMake][i1e0]][l1e0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] |
| RISCV | [![CMake][i1f0]][l1f0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] |
| LOONGARCH | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] |
| s390x | [![CMake][i1h0]][l1h0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] | ![CMake][d0]<br/>![Bazel][d1]<br/>![Zig][d2] |
...
[l3a2]: https://github.com/google/cpu_features/actions/workflows/amd64_macos_zig.yml
...
[l4a2]: https://github.com/google/cpu_features/actions/workflows/amd64_windows_zig.yml
