...
static const CapabilityConfig kConfigs[] = {
    ...
    [AARCH64_ASIMD] = {{AARCH64_HWCAP_ASIMD, 0},
                       "asimd",
                       &set_asimd,
                       &get_asimd},
    [AARCH64_EVTSTRM] = {{AARCH64_HWCAP_EVTSTRM, 0},
                         "evtstrm",
                         &set_evtstrm,
                         &get_evtstrm},
    [AARCH64_AES] = {{AARCH64_HWCAP_AES, 0}, "aes", &set_aes, &get_aes},
    [AARCH64_PMULL] = {{AARCH64_HWCAP_PMULL, 0},
                       "pmull",
                       &set_pmull,
                       &get_pmull},
    [AARCH64_SHA1] = {{AARCH64_HWCAP_SHA1, 0}, "sha1", &set_sha1, &get_sha1},
    [AARCH64_SHA2] = {{AARCH64_HWCAP_SHA2, 0}, "sha2", &set_sha2, &get_sha2},
    [AARCH64_CRC32] = {{AARCH64_HWCAP_CRC32, 0},
                       "crc32",
                       &set_crc32,
                       &get_crc32},
    [AARCH64_ATOMICS] = {{AARCH64_HWCAP_ATOMICS, 0},
                         "atomics",
                         &set_atomics,
                         &get_atomics},
    [AARCH64_FPHP] = {{AARCH64_HWCAP_FPHP, 0}, "fphp", &set_fphp, &get_fphp},
    [AARCH64_ASIMDHP] = {{AARCH64_HWCAP_ASIMDHP, 0},
                         "asimdhp",
                         &set_asimdhp,
                         &get_asimdhp},
    [AARCH64_CPUID] = {{AARCH64_HWCAP_CPUID, 0},
                       "cpuid",
                       &set_cpuid,
                       &get_cpuid},
    [AARCH64_ASIMDRDM] = {{AARCH64_HWCAP_ASIMDRDM, 0},
                          "asimdrdm",
                          &set_asimdrdm,
                          &get_asimdrdm},
    [AARCH64_JSCVT] = {{AARCH64_HWCAP_JSCVT, 0},
                       "jscvt",
                       &set_jscvt,
                       &get_jscvt},
    [AARCH64_FCMA] = {{AARCH64_HWCAP_FCMA, 0}, "fcma", &set_fcma, &get_fcma},
    [AARCH64_LRCPC] = {{AARCH64_HWCAP_LRCPC, 0},
                       "lrcpc",
                       &set_lrcpc,
                       &get_lrcpc},
    [AARCH64_DCPOP] = {{AARCH64_HWCAP_DCPOP, 0},
                       "dcpop",
                       &set_dcpop,
                       &get_dcpop},
    ...
    [AARCH64_ASIMDDP] = {{AARCH64_HWCAP_ASIMDDP, 0},
                         "asimddp",
                         &set_asimddp,
                         &get_asimddp},
    [AARCH64_SHA512] = {{AARCH64_HWCAP_SHA512, 0},
                        "sha512",
                        &set_sha512,
                        &get_sha512},
    [AARCH64_SVE] = {{AARCH64_HWCAP_SVE, 0}, "sve", &set_sve, &get_sve},
    [AARCH64_ASIMDFHM] = {{AARCH64_HWCAP_ASIMDFHM, 0},
                          "asimdfhm",
                          &set_asimdfhm,
                          &get_asimdfhm},
    [AARCH64_DIT] = {{AARCH64_HWCAP_DIT, 0}, "dit", &set_dit, &get_dit},
    [AARCH64_USCAT] = {{AARCH64_HWCAP_USCAT, 0},
                       "uscat",
                       &set_uscat,
                       &get_uscat},
    [AARCH64_ILRCPC] = {{AARCH64_HWCAP_ILRCPC, 0},
                        "ilrcpc",
                        &set_ilrcpc,
                        &get_ilrcpc},
    [AARCH64_FLAGM] = {{AARCH64_HWCAP_FLAGM, 0},
                       "flagm",
                       &set_flagm,
                       &get_flagm},
    ...
    [AARCH64_DCPODP] = {{0, AARCH64_HWCAP2_DCPODP},
                        "dcpodp",
                        &set_dcpodp,
                        &get_dcpodp},
    [AARCH64_SVE2] = {{0, AARCH64_HWCAP2_SVE2}, "sve2", &set_sve2, &get_sve2},
    [AARCH64_SVEAES] = {{0, AARCH64_HWCAP2_SVEAES},
                        "sveaes",
                        &set_sveaes,
                        &get_sveaes},
    [AARCH64_SVEPMULL] = {{0, AARCH64_HWCAP2_SVEPMULL},
                          "svepmull",
                          &set_svepmull,
                          &get_svepmull},
    [AARCH64_SVEBITPERM] = {{0, AARCH64_HWCAP2_SVEBITPERM},
                            "svebitperm",
                            &set_svebitperm,
                            &get_svebitperm},
    [AARCH64_SVESHA3] = {{0, AARCH64_HWCAP2_SVESHA3},
                         "svesha3",
                         &set_svesha3,
                         &get_svesha3},
    [AARCH64_SVESM4] = {{0, AARCH64_HWCAP2_SVESM4},
                        "svesm4",
                        &set_svesm4,
                        &get_svesm4},
    [AARCH64_FLAGM2] = {{0, AARCH64_HWCAP2_FLAGM2},
                        "flagm2",
                        &set_flagm2,
                        &get_flagm2},
    [AARCH64_FRINT] = {{0, AARCH64_HWCAP2_FRINT},
                       "frint",
                       &set_frint,
                       &get_frint},
    [AARCH64_SVEI8MM] = {{0, AARCH64_HWCAP2_SVEI8MM},
                         "svei8mm",
                         &set_svei8mm,
                         &get_svei8mm},
    [AARCH64_SVEF32MM] = {{0, AARCH64_HWCAP2_SVEF32MM},
                          "svef32mm",
                          &set_svef32mm,
                          &get_svef32mm},
    [AARCH64_SVEF64MM] = {{0, AARCH64_HWCAP2_SVEF64MM},
                          "svef64mm",
                          &set_svef64mm,
                          &get_svef64mm},
    [AARCH64_SVEBF16] = {{0, AARCH64_HWCAP2_SVEBF16},
                         "svebf16",
                         &set_svebf16,
                         &get_svebf16},
